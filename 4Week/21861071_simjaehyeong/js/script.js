...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 3.
        // console.log($('a[href^="http://"]')); // URL 링크 속성값은 "http://~~"" 이니 공통으로 포함하는 부분인 "http://"으로 찾는다.
        $('a[href^="http://"]').addClass('underline');   //이건 "http://"를 포함했다면 불러온다.
        // $('a[href="http://"]').addClass('underline'); //이건  아예 "http://"만 있는 친구만 불러온다.
