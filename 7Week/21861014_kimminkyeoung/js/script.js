(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        $('div#hello').eq(0).append('<span id = "my-name">제 이름은 김민경 입니다.</span>')
        ...
        */
        ...
        for(var i = 0; i < imagesLength; i++){
            var $bannerItems = $('div.banner-container').append('<div class = "banner-item"></div>');
            $bannerItems.append(" <img src =' " + images[i] + " '>");
            // 이게 맞나요 . . .? ^0^;7
        }
        */
        /*
       for(var i = 0; i < imagesLength; i++){
        $('div.banner-container').append('<div class = "banner-item"></div>').eq(i).append(" <img src =' " + images[i] + " '>");
       }
       */
      for(var i = 0; i < imagesLength; i++){
          $('div.banner-container').append('<div class="banner-item"></div>');
          $('div.banner-item').eq(i).append('<img src = "' + images[i] + '">');
      }
        ...
        */
        ...
        var $top = $('body').children().eq(0).prepend($moveTop);
        ...
        */
        ...
        $('body').children().last().after($moveBottom);
        $moveBottom.addClass('move').html('아래로 이동 했습니다.');
        ...
        */
        //Answer 8.
        var $list1li = $('ul.list-1').find('li').eq(0);
        for(var i = 2; i < 5; i++){
            $list1li.append('<li>리스트 '+i+'</li>');
        }
        ...
        */
        //Answer 9.
        var $list2li = $('ul.list-2').find('li').eq(0);
        for(var i = 4; i >= 1; i--){
            $list2li.prepend('<li>리스트 '+i+'</li>');
        }
