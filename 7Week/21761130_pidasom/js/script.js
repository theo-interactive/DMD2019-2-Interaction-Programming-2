(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        $('div#hello').eq(0).append('<span id = "my-name">제 이름은 P다솜 입니땅 ^♡^ ~ </span>')
        ...
        */
        ...
        $top.addClass('move').html('위로 이동합니땅 ↑');
        ...
        */
        ...
        $moveBottom.addClass('move').html('아래로 이동합니땅 ↓');
