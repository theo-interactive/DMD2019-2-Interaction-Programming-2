(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        $('#hello').append('<span id="my-name">제 이름은 박혜진입니다.</span>');
        ...
        */
        ...
        for (var i = 0; i < images.length; i++) {
            // $('.banner-container').append('<div class="banner-item"></div>');
            // console.log(images[i]);
            // console.log('<img src="images[i]">');
            // console.log('<img src="' + images[i] + '">');
            // $('.banner-item').eq(i).append('<img src="' + images[i] + '"></img>');
            $('.banner-container').append('<div class="banner-item"><img src="' + images[i] + '"></img></div>');
        }
        ...
        */
        ...
        $moveTop.addClass('move').html('').text('위로 이동했습니다.');
        ...
        */
        //Answer 4.
        var $moveBottom = $('p.move-bottom');
        // console.log($('body').children());
        $('body').children().eq(5).after($moveBottom);
        $moveBottom.addClass('move').html('').text('아래로 이동했습니다.');
        ...
        */
        //Answer 8.
        // console.log($('ul.list-1').children());
        // console.log($('ul.list-1').children().eq(0));
        for (var i = 4; i > $('ul.list-1').children().eq(0).length; i--) {
            $('ul.list-1').children().eq(0).after('<li>' + '리스트 ' + i + '</li>');
        }
        ...
        */
        //Answer 9.
        // console.log($('ul.list-2').children());
        // console.log($('ul.list-2').children().eq(0));
        for (var i = 4; i > $('ul.list-2').children().eq(0).length - 1; i--) {
            $('ul.list-2').children().eq(0).before('<li>리스트 ' + i + '</li>');
        }
