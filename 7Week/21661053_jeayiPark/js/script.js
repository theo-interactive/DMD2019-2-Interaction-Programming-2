(function($){
    $(document).ready(function(){
        //Quest 1.
        /*
        my-name 아이디를 가진 span 요소를 생성하고 ‘제 이름은 본인이름입니다.’ 의
        내용을 추가하여 hello 아이디를 가진 div 노드의 첫 번째 자식노드로 추가합니다.
        */
        //Answer 1.

        $('div#hello').eq(0).append('<span id="my-name">제 이름은 박재이입니다</span>')
        ...
        */
        //Answer 3.
        $('p.move-top').eq(0).insertBefore($('body'));
        ...
        */
        ...
        $('p.move-bottom').eq(0).insertAfter($('body'));
        ...
        */
        //Answer 6.
        $('p.modify').html('<span>수정되었습니다.</span>');
        ...
        */
        ...
        //Quest 8.
        /*
        ul.list-1 의 첫번 째 li 자식노드의 뒤에 반복문을 이용하여‘리스트 2,‘리스트 3,‘리스트 4’의  
        내용을 가지는 li 요소를 생성한 후 추가합니다.
        */
        //Answer 8.
        for (var i = 0; i < 3; i++)
        {
            $('ul.list-1').eq(0).children().after('<li>리스트' + (i + 2) + '</li>')
        }
        ...
        */
        //Answer 9.
        for (var i = 0; i < 3; i++) {
            $('ul.list-1').eq(0).children().before('<li>리스트' + (i + 2) + '</li>')
        }
