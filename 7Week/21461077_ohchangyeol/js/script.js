(function($){
    $(document).ready(function(){
        ...
        */
        ...
        $('#hello').append('<span id="my-name">제 이름은 오창열입니다.</span>');
        ...
        */
        ...
        //     $('.banner-container').prepend('<div class="banner-item"><img src= "'+images[i]+'"></img></div>')
        ...
        */
        //Answer 3.
        // console.log($('body').children().eq(0));
        ...
        */
        ...
        $('body').children().eq($bodyLength-1).after($moveBottom);
        // console.log($('body').children().eq($bodyLength));
        $moveBottom.addClass('move');
        // if($('p.move-top').has('.move')){
        if($moveBottom.has('.move')){
            // console.log('d');
            $moveBottom.html('');
            // $moveTop.html('위로 이동했습니다.');
        ...
        */
        ...
        for(var i = 2 ; i <=4 ; i++){
            var $list1Children = $('ul.list-1').children().eq(i-2);
            // console.log($list1Children);
            $list1Children.after('<li>리스트 '+i+'</li>');
        }
        ...
        */
        //Answer 9.
        var $list2Children = $('ul.list-2').children().eq(0);
        // console.log($list2Children);
        for(var i = 1 ; i <=4 ; i++){
            $list2Children.before('<li>리스트 '+i+'</li>');
        }
        ...
        */
        ...
        $('button.btn-1').click(function (e) { 
            ...
            // $box1.css('width', $box1width+'100px');
            // $box1.css('width', '+=100px');
            // console.log($box1.hasClass('plus'));
            
            if($box1.hasClass('plus') === true){
                console.log('+');
                $box1.css('width', '+=100px');
                if($box1width === 400){
