...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 2.
        $('a').children('span').addClass('inner');
        ...
        */
        ...
        console.log($('.type-2').parent().index());//말그대로 index()의 값
        ...
        */
        ...
        //$('ul.gub').find('li').eq(6).find('a');
        //위치를 찾아 찾겠다.
        console.log(
            $('a:contains("Menu 7")')
            //문자열 포함 찾겠다.//contains(컨테인)> '텍스트'를 포함
        )
       ...
       // $('input[type=radio]#radio-2')
        ...
        1) 자식노드 a 요소에 emphasis 클래스를 추가합니다. >바로 밑 직계에서만 찾음
        / 2) 모든 자식노드 a 요소들에 bold 클래스를 추가합니다.>바로 밑에 전부 찾음
        */
        //Answer 8.
