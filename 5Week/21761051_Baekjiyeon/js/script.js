...
            // $('ul.gnb').find('li').eq(6).find('a');
	        ...
	        */
            ...
            //$('#radio-2').parent().find('label').addClass('emphasis');
	        ...
	        */
	        ...
	        $('li.sub-last').parents('.last').children('a').addClass('emphasis').find('a').addClass('bold');
