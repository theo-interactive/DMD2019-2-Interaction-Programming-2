...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 2.
        var _hasA = $('a:has(span)');
        console.log(_hasA); 

        _hasA.addClass('inner');
        ...
        */
        ...
        console.log(_radio.val()); 
        console.log($('#radio-1:has(value)')); //보류
        ...
        */
        ...
        //$('#ridio-2');
        // $('input#ridio-2').parent().find('label').addClass('emphasis');
        $('input[type="ridio-2"]').not('#ridio-2').parent().find('label').addClass('emphasis');
        ...
        */
        ...
        var zero = $('li.sub-last').parents('.last');
        console.log(zero);

        console.log(zero.children('a'));
        zero.children('a').addClass('emphasis');
        zero.find('a').addClass('bold');
