...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 7.
        //$('input[type=radio]#radio-2').parent().find('label').addClass('emphasis');
        $('input[type=radio]#radio-2').not('#radio-2').parent().find('label').addClass('emphasis');
