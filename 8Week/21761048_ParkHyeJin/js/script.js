(function($){
    $(document).ready(function(){
        ...
        */
        ...
        // console.log($bannerWidth, $bannerHeight);
        ...
        */
        ...
        //Answer 3.
        var $bannerContainerWidth = $('.banner-item').width() * 5;
        ...
        */
        ...
        //Answer 4.
        var $bannerWrapWidth = $('.banner-wrap').width();
        ...
        */
        ...
        //Answer 5.
        // console.log($('.banner-item').find('img'));
        $('.banner-item').find('img').css('width', '100%');
        ...
        */
        ...
        //Answer 9.
        var $bannerItemWidth = parseInt($('.banner-item').css('width'));
        function slideLeft() {
            for (var _id = 0; _id > - $bannerItemWidth; _id--) {
                $('.banner-container').css({
                    'left' : _id + 'px'
                });
            };
