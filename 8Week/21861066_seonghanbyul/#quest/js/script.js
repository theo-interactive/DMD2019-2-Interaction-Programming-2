(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //Answer 3.
        var $BannerWrapWidth = $BannerWrap.width();  //$BannerWrap 위에서 값을 구함
        //console.log($BannerWrapWidth);
        var $BannerItemLength = $('.banner-item').length;
        //console.log($BannerItemLength);  -> 출력결과 = 5

        var $BannerContainer = $('.banner-container');
        var $BannerContainerWidth = $BannerWrapWidth * $BannerItemLength
        //console.log($BannerContainerWidth);
        $BannerContainer.width($BannerContainerWidth);
        ...
        */
        ...
        //Answer 5.
        var $bannerItemIMG = $('.banner-item').children().find('img');
        ...
        */
        ...
        //Answer 6.
        $('.paddle-nav').find('.arrow.prev').css('left', '18');
        ...
        */
        ...
        //Answer 7.
        $('.paddle-nav').find('.arrow.next').css('right', '18');
