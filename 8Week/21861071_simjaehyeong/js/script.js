(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //Answer 2.
        var wrapwidth = $('.banner').css('width');
        //console.log(wrapwidth);
        var wrapheight = $('.banner').css('height');
        ...
        */
        ...
        //Answer 3.
        //console.log(typeof(wrapwidth));//string
        var numwrap = parseInt(wrapwidth); //string->number
        //console.log(numwrap);
        var itemcount = $('.banner-item').length;
        //console.log(itemcount);
        var a3 = numwrap * itemcount;
        ...
        */
        ...
        //Answer 9.
        //var _id = 0;
        var itemwidth = parseInt($('.banner-item').css('width'));
        function slideLeft(e) {
            //e.preventDefault();
            for(var _id=0; _id>-itemwidth; _id--){
                $('.banner-container').css({
                    'left': _id
                })
            }
