(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //Answer 2.
        var _bannerWidth = $('.banner').width(),_bannerheight = $('.banner').height();
        $('.banner-wrap').css({width:_bannerWidth,height:_bannerheight})
        ...
        */
        ...
        /*
        for (let index = 0; index < $bannerItem.length; index++) {
            console.log(index);
            var _itemWidth = $bannerItem.eq(index).width();
            console.log(index,_itemWidth);
            $('.banner-container').css('width','+='+_itemWidth);
        }
        */
        ...
        for (let index = 0; index < $bannerItem.length; index++) {
            var _itemWidth = $bannerItem.eq(index).width();
            _itemMaxWidth += _itemWidth;
        }
        $('.banner-container').css({width:_itemMaxWidth,height:100+"%"});
        ...
        */
        ...
        //Answer 4.
        $bannerItem.css({float : 'left',width : $(".banner-wrap").width(),height : 100+'%'})
        ...
        */
        ...
        $('.paddle-nav .arrow.prev').css('left' , 18)
        ...
        */
        ...
        $('.paddle-nav .arrow.next').css('right' , 18)
        /*
        Quest 8.
        ...
        */
        ...
        function slideLeft(){
            ...
            console.log(_id)
            if (0< _id) {
                $('.banner-container').css("left",'+='+$bannerItem.width());
            }
            // console.log('left')
        }
        ...
        */
        ...
        function slideRight() {
            ...
            console.log(_id);
            // console.log('right')
            if(_id < $bannerItem.length){
                $('.banner-container').css("right",'+='+$bannerItem.width());
            }
        }

        /*
        Quest 11.
        .arrow.prev 노드 클릭시 slideLeft, .arrow.v 노드 클릭시 slideRight 이벤트가 실행되도록 적용합니다.
        */
