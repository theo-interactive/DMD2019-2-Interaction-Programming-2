(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //Answer 2.
        var $banerWidth = $('.banner').width();
        var $banerHeight = $('.banner').height();

        //console.log($banerWidth);
        $('.banner-wrap').width($banerWidth).height($banerHeight);

        /*
        Quest 3.
        .banner-container 노드의 width 를 .banner-wrap 의 width x .banner-item 의 개수 의 너비만큼 계산하여 적용하고,
         height 는 100% 로 지정합니다.
        */

        //Answer 3.
        var $bannerItemLength = $('.banner-container').children('.banner-item').length; // ->5
        //console.log($bannerItemLength);
        var $bannerWrapWidth = $('.banner-wrap').width(); // 1000
        //console.log($bannerWrapWidth);

        var $bannerItemAllWidth = ($bannerWrapWidth * $bannerItemLength) ;
        //console.log($bannerItemAllWidth); // 5000
        
        $('.banner-container').width($bannerItemAllWidth).height(100+'%');
        ...
        */
        ...
        $('.banner-item').width($bannerWrapWidth).height(100+'%');

        //죄송합니다 ..교수님...
        //인프 중간과제를 열심히 하고 있습니다.
        //꼭 시간내서 다음에 다 하겠습니다...
        ...
        */
        ...
        //$('.banner-item').children("div img").width(100+'%');
