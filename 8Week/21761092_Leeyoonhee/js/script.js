(function($){
    $(document).ready(function(){
        ...
        */
        ...
        var $bannerWt = $('.banner').width();
        var $bannerHt = $('.banner').height();
        $('.banner-wrap').css({'width': $bannerWt, 'height':$bannerHt});
        ...
        */
        ...
        var $container = $bannerWt;
        var $item = $('.banner-item').length;
        var $bannerCn = $container * $item;
        $('.banner-container').css({'width': $bannerCn, 'height':'100%'});
        ...
        */
        ...
        $('.banner-item').css({'width': $container, 'height':'100%'});
        ...
        */
        ...
        $('.banner-item').children().find('img').css('width', '100%');
